...
var Index = function Index() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    axios__WEBPACK_IMPORTED_MODULE_5___default.a.get("http://localhost:5000/todos").then(function (res) {
      var todos = res.data;
  ...
  addTodo = function addTodo() {
    axios__WEBPACK_IMPORTED_MODULE_5___default.a.post("http://localhost:5000/todos", input).then(function (res) {
      console.log(res);
    }).catch(function (err) {
      console.log(err);
    });
  ...
  return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("main", {
    ...
    __self: this
  }, "Todos"), react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("ul", {
    className: "jsx-2333859604",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 44
    ...
    onSubmit: function onSubmit(event) {
      ...
      setTodos([].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(todos), [input]));
      handleInput("");
    },
    className: "jsx-2333859604",
    __source: {
    ...
    __self: this
  }, "Task: "), react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("input", {
    type: "text",
    name: "task",
...
//# sourceMappingURL=index.js.bceb38db5bad873df44b.hot-update.js.map