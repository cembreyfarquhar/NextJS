...
var ChatList = function ChatList(_ref) {
  ...
  var getMessageClassName = function getMessageClassName(msg, prevMsg) {
    ...
    } else if (msg.author !== localStorage.getItem("username")) {
      if (Math.abs(msg.dateTime - prevMsg.dateTime) < 5000) {
        return "user collection";
      } else {
        return "user";
...
//# sourceMappingURL=chatScreen.js.5587ead9dca606308bda.hot-update.js.map